...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Daftar Pesanan yang telah di proses</h4>
                    ...
                    <div class="tab-pane show active" id="buttons-table-preview">
                        <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                $query = "SELECT * FROM pesanan p inner join user u on p.id_user = u.id_user where p.ket = 'proccess'";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td> 
                                            <button class="btn btn-soft-warning rounded-pill"><?= $row['ket'] ?></button>
                                        </td>
                                        <td>
