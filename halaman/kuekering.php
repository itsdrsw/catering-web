...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Daftar Kue Kering</h4>
                <p class="text-muted font-14"></p>
                <a href=".?hal=tambahkuekering"><button class="btn btn-primary btn-sm mb-2">Tambah</button></a>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-info btn-sm" href=".?hal=ubahkuekering&id=<?= $row['id_kue'] ?>">
                                                <i class=" ri-edit-2-fill"></i> Ubah</a>

                                            <a class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus ?')" href=".?hal=hapuskuekering&id=<?= $row['id_kue'] ?>">
