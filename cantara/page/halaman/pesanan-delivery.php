        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex flex-wrap gap-2 mb-2">
                    ...
                    <a href=".?hal=pesanan-delivery"><button type="button" class="btn btn-info ">Pesanan Dikirim</button></a>
                    ...
                    <div class="tab-pane show active" id="buttons-table-preview">
                        <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                $query = "SELECT * FROM pesanan p inner join user u on p.id_user = u.id_user where p.ket = 'Dikirim'";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <h4><a href="#" class="badge badge-info-lighten"><?= $row['ket'] ?></a></h4>
                                        </td>
                                        <td>
