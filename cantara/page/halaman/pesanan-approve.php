...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Daftar Pesanan yang telah di setujui</h4>
                <p class="text-muted font-14"></p>
                <div class="tab-pane show active" id="rounded-buttons-preview">
                    <div class="d-flex flex-wrap gap-2 mb-2">
                        <a href=".?hal=pesanan-approve"><button type="button" class="btn btn-primary ">Pesanan Disetujui</button></a>
                    ...
                    <div class="tab-pane show active" id="buttons-table-preview">
                        <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                $query = "SELECT * FROM pesanan p inner join user u on p.id_user = u.id_user where p.ket = 'Disetujui'";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <h4><a href="#" class="badge badge-primary-lighten"><?= $row['ket'] ?></a></h4>
                                        </td>
                                        <td>
